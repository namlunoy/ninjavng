...
{
	/*auto moveTo1 = MoveTo::create(speed, Vec2(Config::centerPoint.x - 80, Config::centerPoint.y - 80 + 155));
	auto moveTo2 = MoveTo::create(speed, Vec2(Config::centerPoint.x, Config::centerPoint.y + 155));
	auto moveTo3 = MoveTo::create(speed, Vec2(Config::centerPoint.x + 80, Config::centerPoint.y + -80 + 155));*/
	...
	this->runAction(CCRepeatForever::create(Sequence::create(moveTo1, moveTo2, moveTo3, nullptr)));
	this->isMove = true;
}
